...
import edu.duke.cs.banjo.bayesnet.EdgesAsArrayWithCachedStatistics;
import edu.duke.cs.banjo.bayesnet.EdgesAsMatrix;
import edu.duke.cs.banjo.bayesnet.EdgesI;
...
public class PostProcessor {
    ...
    public StringBuffer composeDotGraph( 
		...
		// Static BN case, output static bayesian network structure, modified by GUOSU
		if ( maxMarkovLag == 0 ) {
